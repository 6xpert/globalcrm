...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2">Branch Offices</h3>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Manage branch Office</li>
                                            <li class="breadcrumb-item active" aria-current="page">View All Branch Offices</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                    ...
                                                    <div class="pl-xl-3">
                                                        <div class="m-b-0">
                                                            <div class="user-avatar-name d-inline-block">
                                                                <h2 class="font-24 m-b-10"><?= $row['branchName'] ?></h2>
                                                            </div>
                                                        </div>
                                                        <div class="user-avatar-address">
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                <i class="fas fa-user"></i> <?= ($row['bPersonName'] == '') ? '--' : $row['bPersonName'] ?>&nbsp;&nbsp;&nbsp;
                                                                <i class="fas fa-mobile-alt"></i> <?= ($row['bPersonPhone'] == '') ? '--' : $row['bPersonPhone'] ?>&nbsp;&nbsp;&nbsp;
                                                                <i class="fas fa-envelope"></i> <?= ($row['bPersonEmail'] == '') ? '--' : $row['bPersonEmail'] ?><br>
                                                                <Strong>Website: 
                                                                    <?php
                                                                        if($row['branchWebsite']!=''){
                                                                    ?>
                                                                    <a href="<?=$row['branchWebsite']?>" target="_blank"><?=$row['branchWebsite']?></a>
                                                                    <?php
                                                                        }else{
                                                                            echo 'No available';
                                                                        }
                                                ...
                                                <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                        ...
                                                        <a href="<?= base_url('edit-branch-office/' . $row['branchID']) ?>" class="btn-wishlist m-r-10"><i class="fas fa-edit"></i></a>
                                                        <a href="<?= base_url('deletes-branch-office/' . $row['branchID']) ?>" onclick="return varifyDelete()" class="btn-wishlist m-r-10"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    ?>
    <?php
    if ($this->session->flashdata('Branch-edited') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
            ...
            toastr.success('Branch office Updated!');
        </script>
    <?php
    }
    ?>
