...
<head>
    ...
    <title>Manage Lead Souces</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Lead Sources</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a class="breadcrumb-link">Manage Leads</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Manage Lead Source</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Add Lead Souce</h5>
                                <div class="card-body">
                                    <form id="validationform" method="post" action="<?=base_url('add-lead-source-data')?>"  >
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Lead Source</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" id="source" name="source" required=""  class="form-control">
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">All Lead Source List</h5>
                            </div>
                            <div class="card-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                if($row['sourceStatus']==1){
                                                            ?>
                                                            <a href="<?=base_url('lead-source-mark-Inactive/'.$row['sourceID'])?>" onclick="return markInActive()" class="btn btn-warning">Mark Inactive</a>
                                                            <?php
                                                                }else{
                                                                ?>
                                                            <a href="<?=base_url('lead-source-mark_active/'.$row['sourceID'])?>" onclick="return markActive()" class="btn btn-success">Mark Active</a>
                                                                <?php
                                                            }
                                                            ?>
                                                            <!-- <a href="<?=base_url('edit-country/'.$row['sourceID'])?>" class="btn btn-info">Edit</a> -->
                                                            <a href="<?=base_url('lead-source-delete-data/'.$row['sourceID'])?>" onclick="return deleteCountry()" class="btn btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $sr++;
    ...
    ?>
        <?php
    if ($this->session->flashdata('LeadsInactive') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
    ...
    ?>
        <?php
    if ($this->session->flashdata('LeadDeleted') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
            ...
            toastr.error('Lead Source Deleted!');
        </script>
        <?php
    }
    ?>
        <?php
    if ($this->session->flashdata('LeadsAdded') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
            ...
            toastr.success('New Lead Source Added!');
        </script>
        <?php
    }
    ?>
        <?php
    if ($this->session->flashdata('Leadsactive') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
