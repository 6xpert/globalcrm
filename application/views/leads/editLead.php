        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Edit Lead</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Lead Form</h5>
                            <div class="card-body">
                                <form method="post" enctype='multipart/form-data' action="<?= base_url('update-leads-data/'.$this->uri->segment(2)) ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mt-2">
                                            ...
                                            <select name="source" required id="source" class="form-control">
                                                ...
                                                <option 
                                                <?php
                                                    if($row['sourceID']==$lead[0]['sourceID']){
                                                        echo 'selected';
                                                    }
                                                ?>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            ...
                                            <input type="text" value="<?=$lead[0]['stdName']?>" Required class="form-control" id="stdname" name="stdname">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            <label for="validationCustom01">Student Email<span style="color: red;">*</span></label>
                                            <input type="text" value="<?=$lead[0]['stdEmail']?>" Required class="form-control" id="stdemail" name="stdemail">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            <label for="validationCustom01">Student Phone<span style="color: red;">*</span></label>
                                            <input type="text" value="<?=$lead[0]['stdPhone']?>" Required class="form-control" id="stdphone" name="stdphone">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            <label for="validationCustom01">Additional Phone</label>
                                            <input type="text" value="<?=$lead[0]['stdAddPhone']?>" class="form-control" id="addphone" name="addphone">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            <label for="validationCustom01">Student DOB<span style="color: red;">*</span></label>
                                            <input type="date" value="<?=$lead[0]['stdDOB']?>" Required class="form-control" id="dob" name="dob">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2 ">
                                            <label for="validationCustom01">Estimated Budget</label>
                                            <input type="text" value="<?=$lead[0]['estimatedBudget']?>" class="form-control" id="estBudget" name="estBudget">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            ...
                                            <input type="text" value="<?=$lead[0]['10thMarks']?>" Required class="form-control" id="10marks" name="10marks">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Ielts Status<span style="color: red;">*</span></label>
                                            <input type="text" value="<?=$lead[0]['StdIelts']?>" Required class="form-control" id="ielts" name="ielts">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Funding Mode</label>
                                            <input type="text"  value="<?=$lead[0]['FundingMode']?>" class="form-control" id="fundingMode" name="fundingMode">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Father Name<span style="color: red;">*</span></label>
                                            <input type="text" value="<?=$lead[0]['FatherName']?>" Required class="form-control" id="fname" name="fname">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Ielts Score</label>
                                            <input type="text" value="<?=$lead[0]['stdIletsScore']?>"  class="form-control" id="ieltsScore" name="ieltsScore">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">HSE </label>
                                            <input type="text"  value="<?=$lead[0]['stdHSC']?>" class="form-control" id="hsc" name="hsc">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">UG </label>
                                            <input type="text" value="<?=$lead[0]['stdUG']?>"  class="form-control" id="ug" name="ug">

                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Vise Rejection Issue </label>
                                            <input type="text" value="<?=$lead[0]['viseRejection']?>"  class="form-control" id="viseRejection" name="viseRejection">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Follow Up Date</label>
