                                ...
                                <form method="post" enctype='multipart/form-data' action="<?= base_url('add-representing-institution-data') ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            ...
                                            <input type="number" class="form-control" id="monthlyCost" name="monthlyCost">

                                        </div>

                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom01">Funds Requirement for Visa</label>
                                            <input type="number" class="form-control" id="fundsForVisa" name="fundsForVisa">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            ...
                                            <input type="text"  class="form-control" id="contractTermsLong" name="contractTermsLong">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 pt-2">
                                            ...
                                            <input type="text" required class="form-control" id="contactPersonDesignation" name="contactPersonDesignation">
                                        </div>
