        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Course Level</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Course Level</h5>
                            <div class="card-body">
                                <form id="validationform" method="post" action="<?= base_url('edit-course-level-data/'.$this->uri->segment(2)) ?>">
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Course Level</label>
                                        <div class="col-12 col-sm-8 col-lg-6">
                                            <input type="text" id="level" value="<?=$level[0]['courseLevel']?>" name="level" required="" class="form-control">
                                        </div>
                                    </div>
