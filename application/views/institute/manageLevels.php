...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Course Levels</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a class="breadcrumb-link">Manage Course</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Manage Course Levels</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Add Course Levels</h5>
                            <div class="card-body">
                                <form id="validationform" method="post" action="<?= base_url('add-new-course-level') ?>">
                                    <div class="form-group row">
                                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Course Level</label>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">All Course Levels List</h5>
                            </div>
                            <div class="card-body">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?= base_url('edit-course-level/' . $row['courseLevelID']) ?>" class="btn btn-info">Edit</a>
                                                            <a href="<?= base_url('course-level-delete-data/' . $row['courseLevelID']) ?>" onclick="return deleteCountry()" class="btn btn-danger">Delete</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $sr++;
    ...
    ?>
        <script type="text/javascript">
            ...
            toastr.success('New Level Added!');
        </script>
    <?php
    }
    ?>
