...
<head>
    ...
    <title>Add Representing Countries</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Add Representing Countries</h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Manage Countries</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Representing Countries</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">New Representing Countries Form</h5>
                            <div class="card-body">
                                <form method="post" enctype='multipart/form-data' action="<?=base_url('addrepresenting-data')?>">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="livingCost" name="livingCost"   >
                                            
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-2">
                                            <label for="validationCustom02">Visa Requirement</label>
                                            <textarea name="visaReq" id="visaReq" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-2">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-2">
                                            ...
                                            <textarea name="countryBen" id="countryBen" class="form-control" cols="30" rows="5"></textarea>
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="link1desc" name="link1desc"   >
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="link2desc" name="link2desc"   >
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="link3desc" name="link3desc"   >
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 ">
                                            ...
                                            <input type="text" class="form-control" id="link4desc" name="link4desc"   >
    ...
    <script>
     ...
     <script src="<?=base_url()?>assets/toastr/toastr.min.js"></script>
        <?php
    if ($this->session->flashdata('ErrorUploadingFlag') != '') {
    ?>
        <script type="text/javascript">
            ...
            toastr.error('Error Uploading Flag, Try Again!');
        </script>
        <?php
    }
    ?>
